...
# This is necessary because the per-volume files depend on the parent
# riscv-spec.adoc to include symbols.adoc first — we replicate that here
# without touching the upstream source.
UNPRIV_ROOT="$MANUAL_DIR/src/unpriv.adoc"
if [ -f "$MANUAL_DIR/src/unpriv/unpriv.adoc" ]; then
	UNPRIV_ROOT="$MANUAL_DIR/src/unpriv/unpriv.adoc"
fi
PRIV_ROOT="$MANUAL_DIR/src/priv/priv.adoc"
